...
def load_train_models2():
    # Load data
    #C:\Users\USER\Desktop\HBhon
    csv_file_path = "C:/Users/USER/Desktop/HBhon/CaseStudy105Final/sealevel.csv"
    ...
    if selected == "Hyperparameter Tuning":
        ...
        # Slider for n_estimators
            ...
            if plot_choice == "MAE per Fold (Line Plot)":
                ...
                st.plotly_chart(fig_mae_box)
                df1=pd.DataFrame()
                #csv_file_path = "C:/Users/USER/Desktop/HBhon/sealevel.csv"
                df = pd.read_csv('C:/Users/USER/Desktop/HBhon/CaseStudy105Final/sealevel.csv')
                df1['Year'] = df['Year']
